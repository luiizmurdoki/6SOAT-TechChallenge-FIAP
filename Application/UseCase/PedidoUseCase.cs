...
namespace Application.UseCase
{
    public class PedidoUseCase : IPedidoUseCase
    {
        ...
        private readonly IProdutosGateway _produtoRepository;
        private readonly IClienteGateway _clienteRepository;
        private readonly IMapper _mapper;

        public PedidoUseCase(IPedidoGateway repository, IProdutosGateway produtoRepository, IClienteGateway clienteRepository, IMapper mapper)
        {
