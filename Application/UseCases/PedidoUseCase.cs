...
namespace Application.UseCase
{
    ...
    {
        private readonly IPedidoDataSource _repository;
        private readonly IProdutosDataSource _produtoRepository;
        private readonly IClienteDataSource _clienteRepository;
        private readonly IMapper _mapper;

        public PedidoUseCase(IPedidoDataSource repository, IProdutosDataSource produtoRepository, IClienteDataSource clienteRepository, IMapper mapper)
        {
